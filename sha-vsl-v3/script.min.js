...
async function redirectBasedOnCounter() {
    try {
        ...
        const pages = ["p1/index.html", "p2/index.html"];
        ...
        return "offer.html"; // Fallback para página padrão
    }
}
...
(async function main() {
    ...
    try {
        if (config) {
            ...
            if (showOffer)
            {
                finalPage = await redirectBasedOnCounter();
        ...
        loadContentWithScripts("offer.html", "_By8IGtZwBzUV2B3D2dV9zCG1MVE2");
    }
})();
